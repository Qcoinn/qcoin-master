...
This mechanism has been integrated into Bitcore-Node-Qcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/qcoinpay/insight-api-qcoin#web-socket-api](https://github.com/qcoinpay/insight-api-qcoin#web-socket-api)
* API: [https://github.com/qcoinpay/insight-api-qcoin#instantsend-transactions](https://github.com/qcoinpay/insight-api-qcoin#instantsend-transactions)
...
By default, the Qcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Qcoin Core daemon:
