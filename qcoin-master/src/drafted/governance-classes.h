 ...
 *
 *   // network
 *   CqcoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.qcoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CqcoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: qcoinNetwork
// //   -- signature requirements : Key1(User)
// class CqcoinNetworkVariable : public CGovernanceObject
// {
// private:
