...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "qcoinNetwork") type = qcoinNetwork;
    if(strType == "qcoinNetworkVariable") type = qcoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == qcoinNetwork) s = "qcoinNetwork";
    if(type == qcoinNetworkVariable) s = "qcoinNetworkVariable";
