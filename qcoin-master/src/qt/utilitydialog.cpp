    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Qcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Qcoin Core"));
...
All the Qcoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 QCOIN, 0.1 QCOIN, 1 QCOIN and 10 QCOIN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://qcoinpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://qcoinpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Qcoin Core is shutting down...") + "<br /><br />" +
