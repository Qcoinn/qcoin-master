    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("QCOIN-light"), QVariant("light"));
    ui->theme->addItem(QString("QCOIN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("QCOIN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("QCOIN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("QCOIN-traditional"), QVariant("trad"));
