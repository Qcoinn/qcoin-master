...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Qcoin related functionality
...
/*
    ...
    allow endless transaction that would bloat Qcoin and make it unusable. To
